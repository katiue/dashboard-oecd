...
export function processBumpData(csvData: string, config: BumpChartConfig): any[] {
...
// Validate CSV for bump chart
export function validateCsvForBump(csvData: string, config: BumpChartConfig): { valid: boolean; missingColumns: string[]; availableColumns: string[] } {
