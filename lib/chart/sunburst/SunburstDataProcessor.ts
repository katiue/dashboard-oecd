...
export function processSunburstData(csvData: string, config: SunburstChartConfig): any {
...
export function validateCsvForSunburst(csvData: string, config: SunburstChartConfig): { valid: boolean; missingColumns: string[]; availableColumns: string[] } {
